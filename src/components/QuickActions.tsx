        ...
        <CardContent className="pt-6 h-full flex flex-col">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col">
            <div className="w-full flex justify-center mb-6">
              <TabsList className="grid grid-cols-3 gap-2 w-fit max-w-[300px] h-14 bg-white/60 dark:bg-gray-800/60 p-1 shadow-inner border border-gray-200/50 dark:border-gray-700/50 rounded-lg mobile-tabs">
                ...
                <div className="flex flex-col h-full">
                  <div className="mb-4 flex-shrink-0">
                    ...
                    <Input
                      ...
                      className="h-11 text-base border-2 border-gray-200/80 focus:border-slate-400 dark:border-gray-700/80 dark:focus:border-slate-500 transition-all duration-200 bg-white/80 dark:bg-gray-800/80 font-light placeholder:font-light hover:border-slate-300 hover:shadow-sm mobile-input"
                      disabled={isLoading}
                    />
                  </div>
                  <div className="mt-auto pt-4 flex-shrink-0">
                    <Button 
                      ...
                      className="w-full h-11 text-sm font-light bg-slate-700 hover:bg-slate-800 text-white border-0 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.02] mobile-touch"
                    >
                ...
                <div className="flex flex-col h-full">
                  <div className="mb-4 flex-1 flex flex-col min-h-0">
                    ...
                    <Textarea
                      ...
                      className="flex-1 min-h-[120px] text-base border-2 border-gray-200/80 focus:border-green-400 dark:border-gray-700/80 dark:focus:border-green-500 transition-all duration-200 resize-none bg-white/80 dark:bg-gray-800/80 font-light placeholder:font-light hover:border-green-300 hover:shadow-sm mobile-textarea"
                      disabled={isLoading}
                    />
                  </div>
                  <div className="mt-auto pt-4 flex-shrink-0">
                    <Button 
                      ...
                      className="w-full h-11 text-sm font-light bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white border-0 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.02] mobile-touch"
                    >
              ...
              <TabsContent value="pdf" className="flex-1 flex flex-col m-0 data-[state=inactive]:hidden h-full">
                <div className="flex flex-col h-full">
                  <div className="mb-4 flex-shrink-0">
                    ...
                    <div className="h-11 border-2 border-gray-200/80 rounded-md bg-white/80 dark:bg-gray-800/80 dark:border-gray-700/80 flex items-center px-3 transition-all duration-200 hover:border-orange-300 dark:hover:border-orange-600 hover:shadow-sm mobile-input">
                  ...
                  <div className="mt-auto pt-4 flex-shrink-0">
                    <Button 
                      ...
                      className="w-full h-11 text-sm font-light bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white border-0 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.02] mobile-touch"
                    >
